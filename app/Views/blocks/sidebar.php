<aside class="main-sidebar sidebar-dark-navy elevation-4" style="background-color: #001f3f;">
    ...
    <a href="#" class="brand-link">
        <img src="./public/dist/img/logo-gv.png" alt="Logo Brand" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="./public/dist/img/avatar-me.png" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
